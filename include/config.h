...
//
// Текущий режим — TWR (2 якоря + 1 тег, классическая триангуляция).
// Раскомментируйте PDOA_MODE для режима с одним якорем.
// #define PDOA_MODE
...
// ----- Тайминги --------------------------------------------
#define POLL_INTERVAL_MS    200    // период запроса AT+DISTANCE / чтения PDOA (мс)
#define ANCHOR2_STALE_MS   1000    // данные anchor2 «протухают» через N мс
